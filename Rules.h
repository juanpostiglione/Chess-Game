...
public:
    ...
    /// FUNCTION FOR RULE MOVEMENT FOR WHITE PIECE ///
    ...
    /// FUNCTION FOR RULE MOVEMENT FOR BLACK PIECE ///
   virtual void blackPieceRule(sf::Event& event, sf::RenderWindow& gameWindow,
                     ...
                     int posX, int positionY,const sf::Vector2i& mouse) const = 0;
    /// FUNCTION FOR MOVEMENT BEHAVIOR OF WHITE PIECES ///
    ...
    /// FUNCTION FOR MOVEMENT BEHAVIOR OF BLACK PIECES ///
