...
public:
    ...
    void capturePiece(sf::Event& event, sf::RenderWindow& gameWindow,
                  vector<sf::Sprite>& piece, vector<vector<sf::Sprite>>& chosePiece, sf::Mouse::Button mouseButton, int positionX, int positionY);
    ...
    void isKingOutOfBoard(sf::Event& event, sf::RenderWindow& gameWindow,sf::Sprite& sprite,vector<vector<sf::Sprite>>& pieces, sf::Mouse::Button mouseButton);
